...
public final class WebCrawlerMain {
  ...
  private void run() throws Exception {
    System.out.println("SecondProject crawler is starting its fresh run.");
    ...
    System.out.println("SecondProject crawler finished cleanly. Thanks for running this fresh build.");
  }
